...
namespace ConsoleAppAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            uint secondNumber = (uint)Convert.ToInt32(Console.ReadLine()) + 25;
            Console.WriteLine(secondNumber);
            Console.ReadLine();

            Console.WriteLine("Let's enter a new number with a decimal, and divide it by 12.5!\nPress Enter to continue.");
            decimal thirdNumber = (decimal)Convert.ToInt32(Console.ReadLine());
            decimal result1 = (decimal)thirdNumber / 12.5m;
