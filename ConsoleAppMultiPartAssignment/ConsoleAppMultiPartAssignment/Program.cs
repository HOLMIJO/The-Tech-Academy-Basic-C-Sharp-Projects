...
namespace ConsoleAppMultiPartAssignment
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                // If the empty list contains an identical string...
                if (mtList.Contains(same))
                {
                    // Then this message including the string will display.
                    Console.WriteLine("The item " + same + " has occurred before.");
                }
                // If the empty list does NOT contain an identical string...
                else
                {
                    // Then this message including the string will display.
                    Console.WriteLine("The item " + same + " has NOT appeared before.");
                }
                //This adds the current item from the main list (sameList) to the backup list (mtList).
                mtList.Add(same);
            }
            Console.ReadLine();
        }
